...
var buildSubAccountState = (runtime2, events, subAccount, currentTimestamp) => {
  const windowDuration = BigInt(runtime2.config.windowDurationSeconds);
...
var onProtocolExecution = (runtime2, payload) => {
  ...
  try {
    ...
    const state = buildSubAccountState(runtime2, allEvents, newEvent.subAccount, currentTimestamp);
...
var onCronRefresh = (runtime2, payload) => {
  ...
  try {
    ...
    for (const subAccount of subaccounts) {
      try {
        ...
        const state = buildSubAccountState(runtime2, allEvents, subAccount, currentTimestamp);
