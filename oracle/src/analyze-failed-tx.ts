...
const MODULE_ABI = parseAbi([
  ...
  "function batchUpdate(address subAccount, uint256 expectedAllowanceVersion, uint256 newAllowance, address[] calldata tokens, uint256[] calldata expectedTokenVersions, uint256[] calldata balances) external",
